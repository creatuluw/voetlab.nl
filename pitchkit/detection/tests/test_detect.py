...
from pitchkit.detection.detect import BALL, PERSON, annotate, boxes_from_result, detect
...
def test_detect_smoke_on_footage():
    from pitchkit.core.fixtures import dump_artifacts, load_sample_frames
