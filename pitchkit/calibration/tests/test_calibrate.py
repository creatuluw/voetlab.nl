...
import pitchkit.calibration.features  # noqa: F401  (registers "calibrate")
import pitchkit.calibration.keypoint as kp_mod
...
def test_calibrate_produces_H(monkeypatch):
    ...
    monkeypatch.setattr("pitchkit.calibration.tvcalib_solver.calibrate_with_tvcalib", lambda *a, **k: None)
    import cv2
