# pitchkit/calibration — pitch homography (broadcast px → real-world metres)
...
```python
from pitchkit.calibration.homography import estimate_homography, px_to_meters, self_verify
...
## Original reference
None in `src/` (distances were pixels there). Built fresh — TVCalib (WACV23, MM4SPA/tvcalib).
