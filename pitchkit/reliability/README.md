# pitchkit/reliability — per-stat confidence (the PREDA signal)

PREDA's product moat is "a reliability signal on every number". Instead of inventing a score,
...
## Original reference
None in `src/`. Built fresh — the PREDA product moat.
