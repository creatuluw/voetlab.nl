...
CLI: ``python -m pitchkit.report <video> [--max-frames N] [--out DIR] [--ball-model-path P]``
Python: ``pitchkit.report("football-1.mp4", "out", max_frames=50, meta={...})``
"""
...
def main(argv=None):
    ...
    ap = argparse.ArgumentParser(prog="pitchkit.report")
    ap.add_argument("video")
    ap.add_argument("--out", default="pitchkit_report")
    ...
    print(f"[pitchkit.report] ok={res.ok} -> {out / 'summary.json'}")
