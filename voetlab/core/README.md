# voetlab/core — shared contracts (no feature logic)
...
from voetlab.core.provenance import attach_provenance
from voetlab.core.fixtures import load_sample_frames, dump_artifacts
