...
Canonical test footage: ``football-1.mp4`` (override with the ``VOETLAB_FOOTAGE`` env
...
DEFAULT_FOOTAGE: str = os.environ.get("VOETLAB_FOOTAGE", "football-1.mp4")

# Artifacts land under <voetlab-project>/tests/out/<feature>/
_PROJECT_ROOT = Path(__file__).resolve().parents[2]  # .../voetlab/
DEFAULT_OUT: Path = Path(os.environ.get("VOETLAB_OUT", _PROJECT_ROOT / "tests" / "out"))
