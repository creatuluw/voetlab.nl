"""voetlab — standalone football video-analytics framework.
...
Conventions (see docs/wiki/rules/voetlab-framework-conventions-*.md):
...
# Top-level convenience API: `import voetlab; voetlab.run(video)`.
