# voetlab/tactics — pitch control & Voronoi (pure functions, not yet `@feature`s)
...
After T4/T5 land metric coords + velocity in the pipeline. These are voetlab's tactical
differentiators (space creation, passing-lane value).

## Original reference
Built fresh — no legacy code carried over.
