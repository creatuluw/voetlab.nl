...
from voetlab.calibration.homography import estimate_homography
from voetlab.calibration.metric import tracks_to_metric
...
def test_voronoi_feature_runs_with_H():
    ...
    import voetlab.tactics.features  # noqa: F401
